...
<head>
<meta charset="utf-8"/>
<title>MyHotelCuy | @yield('anak3')</title>
...
<link href="{{asset('ssets/plugins/fullcalendar/fullcalendar/fullcalendar.css')}}" rel="stylesheet" type="text/css"/>
...
<script src="{{asset('assets/plugins/uniform/jquery.uniform.min.js')}}s" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
